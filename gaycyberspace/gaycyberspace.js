...
// include: /tmp/tmpslgxoc90.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'gaycyberspace/gaycyberspace.data';
      var REMOTE_PACKAGE_BASE = 'gaycyberspace.data';
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_gaycyberspace/gaycyberspace.data');
      }
      Module['addRunDependency']('datafile_gaycyberspace/gaycyberspace.data');
    ...
    loadPackage({"files": [{"filename": "/assets/favicon.ico", "start": 0, "end": 5025}, {"filename": "/assets/snile.png", "start": 5025, "end": 6863}, {"filename": "/assets/style.css", "start": 6863, "end": 8963}], "remote_package_size": 8963});

  })();

// end include: /tmp/tmpslgxoc90.js
// include: /tmp/tmpf4bb9hsy.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpf4bb9hsy.js
// include: /home/gabby/libs/emsdk/upstream/emscripten/src/emrun_prejs.js
/**
 * @license
...
// end include: /home/gabby/libs/emsdk/upstream/emscripten/src/emrun_prejs.js
// include: /tmp/tmpejauy13t.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpejauy13t.js
...
function findWasmBinary() {
  return locateFile('gaycyberspace.wasm');
}
...
var ASM_CONSTS = {
  91606: () => { if (document.fullscreenElement) return 1; },  
 91652: () => { return Module.canvas.width; },  
 91684: () => { return parseInt(Module.canvas.style.width); },  
 91732: () => { document.exitFullscreen(); },  
 91759: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 91831: () => { if (document.fullscreenElement) return 1; },  
 91877: () => { return Module.canvas.width; },  
 91909: () => { return screen.width; },  
 91934: () => { document.exitFullscreen(); },  
 91961: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 92155: () => { return window.innerWidth; },  
 92181: () => { return window.innerHeight; },  
 92208: () => { if (document.fullscreenElement) return 1; },  
 92254: () => { return Module.canvas.width; },  
 92286: () => { return parseInt(Module.canvas.style.width); },  
 92334: () => { if (document.fullscreenElement) return 1; },  
 92380: () => { return Module.canvas.width; },  
 92412: () => { return screen.width; },  
 92437: () => { return window.innerWidth; },  
 92463: () => { return window.innerHeight; },  
 92490: () => { if (document.fullscreenElement) return 1; },  
 92536: () => { return Module.canvas.width; },  
 92568: () => { return screen.width; },  
 92593: () => { document.exitFullscreen(); },  
 92620: () => { if (document.fullscreenElement) return 1; },  
 92666: () => { return Module.canvas.width; },  
 92698: () => { return parseInt(Module.canvas.style.width); },  
 92746: () => { document.exitFullscreen(); },  
 92773: ($0) => { Module.canvas.style.opacity = $0; },  
 92811: () => { return screen.width; },  
 92836: () => { return screen.height; },  
 92862: () => { return window.screenX; },  
 92889: () => { return window.screenY; },  
 92916: () => { return window.devicePixelRatio; },  
 92952: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 93005: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 93056: () => { Module.canvas.style.cursor = 'none'; },  
 93093: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 93349: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 93400: () => { if (document.pointerLockElement) return 1; },  
 93447: () => { if (document.fullscreenElement) return 1; },  
 93493: () => { return window.innerWidth; },  
 93519: () => { return window.innerHeight; }
};
...
// include: /home/gabby/libs/emsdk/upstream/emscripten/src/emrun_postjs.js
/**
 * @license
 * Copyright 2013 The Emscripten Authors
 * SPDX-License-Identifier: MIT
...
// end include: /home/gabby/libs/emsdk/upstream/emscripten/src/emrun_postjs.js
